...
function hitungGaji($jam_kerja, $upah_per_jam, $upah_lembur, $batas_jam)
{
    $jam_lembur = 0;
    $total_gaji = 0;
    ...
    if ($jam_kerja <= $batas_jam) {
        ...
        $total_gaji = ($batas_jam * $upah_per_jam) + ($jam_lembur * $upah_lembur);
    }
...
$upah_per_jam = 2000;  // upah per jam normal
$upah_lembur = 3000;  // upah per jam lembur
$batas_jam = 48;      // batas jam kerja normal


// Validasi input jam kerja
if (empty($jam_kerja)) {
    $errors[] = "Jumlah jam kerja harus diisi";
...
<body class="flex items-center justify-center min-h-screen bg-gray-900">
    <div class="w-full max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400">Karyawan Perusahaan</p>
        </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo min($jam_kerja, $batas_jam); ?> jam</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Upah normal:</span>
                            <span class="font-medium text-gray-900 dark:text-white"><?php echo formatRupiah(min($jam_kerja, $batas_jam) * $upah_per_jam); ?></span>
                        </div>
                        <?php if ($jam_lembur > 0): ?>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white"><?php echo formatRupiah($jam_lembur * $upah_lembur); ?></span>
                            </div>
                        <?php else: ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600 dark:text-gray-400">Jam lembur:</span>
